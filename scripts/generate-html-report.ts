...
if (!fs.existsSync(reportPath)) {
  ...
  console.log('Usage: ts-node generate-html-report.ts [path-to-json-report]');
  process.exit(1);
}

const report: ConsolidatedReport = JSON.parse(fs.readFileSync(reportPath, 'utf-8'));
...
console.log(`📊 Summary: ${report.summary.totalPassed}/${report.summary.totalScenarios} tests passed`);
console.log(`🌐 Open the report: open ${outputPath}`);
